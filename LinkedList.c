...
bool LinkedList_remove(LinkedList_t *ptLinkedList, void *pvElement)
{
    ...
    if(!LinkedList_isEmpty(ptLinkedList))
    {
        ...
        ptLinkedList->ptElemHeaderArray[i32RemovedElemIndex].i32PreviousIndex = -1;
        ptLinkedList->ptElemHeaderArray[i32RemovedElemIndex].i32NextIndex = -1;
...
bool LinkedList_insertEnd(LinkedList_t *ptLinkedList, void *pvElement)
{
